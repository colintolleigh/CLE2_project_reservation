                ...
                <article class="site-content">
                    ...
                    <form action="" method="post">
                        <div class="data-field">
                            ...
                            <input id="firstName" type="text" name="firstName" placeholder="Vul hier uw voornaam in" autocomplete="off" />
                            <span class = "error"><?php echo $errorFirstName;?></span>
                            <br><br>
                            <label for="lastName">Achternaam: </label>
                            <input id="lastName" type="text" name="lastName" placeholder="Vul hier uw achternaam in" autocomplete="off" />
                            <span class = "error"><?php echo $errorLastName;?></span>
                            <br><br>
                            <label for="email">E-mail: </label>
                            <input id="email" type="email" name="email" placeholder="Vul hier uw e-mail in" autocomplete="off" />
                            <span class = "error"><?php echo $errorEmail;?></span>
                            <br><br>
                            <label for="number">Telefoonnummer: </label>
                            <input id="number" type="text" name="number"placeholder="Vul hier uw telefoonnummer in" autocomplete="off" />
                            <span class = "error"><?php echo $errorNumber;?></span>
                            <br><br>
                            <label for="model">Sneaker model: </label>
                            <input id="model" type="text" name="model" placeholder="Vul hier in welk sneaker model u gebruikt" autocomplete="off" />
                            <span class = "error"><?php echo $errorModel;?></span>
                            <br><br>
                            <label for="wish">Wensen: </label>
                            <input id="wish" type="text" name="wish" placeholder="Vul hier uw wensen in bijv. restauratie, andere kleur, patroon etc." autocomplete="off" />
